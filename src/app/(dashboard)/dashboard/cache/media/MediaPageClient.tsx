...
const VOICE_PRESETS: Record<string, { id: string; label: string }[]> = {
  ...
  "edge-tts": [
    { id: "de-DE-AmalaNeural", label: "Amala (Germany German)" },
    { id: "en-US-AnaNeural", label: "Ana (United States English)" },
    { id: "en-US-AndrewNeural", label: "Andrew (United States English)" },
    { id: "pt-BR-AntonioNeural", label: "Antonio (Brazil Portuguese)" },
    { id: "en-US-AriaNeural", label: "Aria (United States English)" },
    { id: "en-US-AvaNeural", label: "Ava (United States English)" },
    { id: "en-US-BrianNeural", label: "Brian (United States English)" },
    { id: "en-US-ChristopherNeural", label: "Christopher (United States English)" },
    { id: "de-DE-ConradNeural", label: "Conrad (Germany German)" },
    { id: "es-MX-DaliaNeural", label: "Dalia (Mexico Spanish)" },
    { id: "fr-FR-DeniseNeural", label: "Denise (France French)" },
    { id: "it-IT-DiegoNeural", label: "Diego (Italy Italian)" },
    { id: "ru-RU-DmitryNeural", label: "Dmitry (Russia Russian)" },
    { id: "fr-FR-EloiseNeural", label: "Eloise (France French)" },
    { id: "it-IT-ElsaNeural", label: "Elsa (Italy Italian)" },
    { id: "en-US-EmmaNeural", label: "Emma (United States English)" },
    { id: "en-US-EricNeural", label: "Eric (United States English)" },
    { id: "pt-BR-FranciscaNeural", label: "Francisca (Brazil Portuguese)" },
    { id: "en-US-GuyNeural", label: "Guy (United States English)" },
    { id: "fr-FR-HenriNeural", label: "Henri (France French)" },
    { id: "it-IT-IsabellaNeural", label: "Isabella (Italy Italian)" },
    { id: "en-US-JennyNeural", label: "Jenny (United States English)" },
    { id: "es-MX-JorgeNeural", label: "Jorge (Mexico Spanish)" },
    { id: "de-DE-KatjaNeural", label: "Katja (Germany German)" },
    { id: "de-DE-KillianNeural", label: "Killian (Germany German)" },
    { id: "zh-CN-liaoning-XiaobeiNeural", label: "liaoning-Xiaobei (China Chinese)" },
    { id: "hi-IN-MadhurNeural", label: "Madhur (India Hindi)" },
    { id: "en-US-MichelleNeural", label: "Michelle (United States English)" },
    { id: "en-US-RogerNeural", label: "Roger (United States English)" },
    { id: "zh-CN-shaanxi-XiaoniNeural", label: "shaanxi-Xiaoni (China Chinese)" },
    { id: "en-US-SteffanNeural", label: "Steffan (United States English)" },
    { id: "ru-RU-SvetlanaNeural", label: "Svetlana (Russia Russian)" },
    { id: "hi-IN-SwaraNeural", label: "Swara (India Hindi)" },
    { id: "pt-BR-ThalitaMultilingualNeural", label: "ThalitaMultilingual (Brazil Portuguese)" },
    { id: "zh-CN-XiaoxiaoNeural", label: "Xiaoxiao (China Chinese)" },
    { id: "zh-CN-XiaoyiNeural", label: "Xiaoyi (China Chinese)" },
    { id: "zh-CN-YunjianNeural", label: "Yunjian (China Chinese)" },
    { id: "zh-CN-YunxiNeural", label: "Yunxi (China Chinese)" },
    { id: "zh-CN-YunxiaNeural", label: "Yunxia (China Chinese)" },
    { id: "zh-CN-YunyangNeural", label: "Yunyang (China Chinese)" },
  ],
  inworld: [
    { id: "Eva", label: "Eva (EN)" },
